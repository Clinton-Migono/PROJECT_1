	...
	<div class="card card-outline card-warning">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-warning " href="./index.php?page=new_parcel"><i class="fa fa-plus"></i> Add New</a>
			</div>
		</div>
		<div class="card-body">
					...
					<tr>
						...
						<td class="text-center">
		                    <div class="btn-group">
		                        ...
		                        <a href="index.php?page=edit_parcel&id=<?php echo $row['id'] ?>" class="btn btn-warning btn-flat ">
