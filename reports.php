	...
	<div class="card card-outline card-warning">
		<div class="card-body">
			...
			$status_arr = array("Item Accepted by Courier","Collected","Shipped","In-Transit","Arrived At Destination","Out for Delivery","Ready to Pickup","Delivered","Picked-up","Unsuccessfull Delivery Attempt"); ?>
                ...
                <button class="btn btn-sm btn-warning mx-1 bg-gradient-warning" type="button" id='view_report'>View Report</button>
			</div>
		</div>
	</div>
	<div class="row">
...
$('#view_report').click(function(){
	...
	if ($('#date_to').val() < $('#date_from').val()) {
        alert_toast("End date cannot be earlier than start date.","error");
        return false;
    }
	load_report()
	var date_from = $('#date_from').val()
