						...
						<div class="row">
							...
							<div class="col-sm-6">
								<dl>
									...
									<dt>Type:</dt>
									<dd><?php echo $type == 1 ? "<span class='badge badge-warning'>Deliver to Recipient</span>":"<span class='badge badge-info'>Pickup</span>" ?></dd>
								</dl>	
							</div>
						</div>
					<dl>
						...
						<dd>
							...
							?>
							<span class="btn badge badge-warning bg-gradient-warning" id='update_status'><i class="fa fa-edit"></i> Update Status</span>
						</dd>
